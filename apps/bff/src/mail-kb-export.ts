...
export async function exportMailKnowledgeBaseDocuments(
  ...
  const report: MailKnowledgeBaseExportReport = {
    ...
    personCount: personRows.length,
    files: [
      "documents/mail-ids.md",
      "documents/mail-subject-index.md",
      "documents/mail-score-index.md",
      "documents/mail-summaries.md",
      "documents/event-clusters.md",
      "documents/sender-profiles.md",
      "documents/baseline-status.json",
      "mails/index.json",
      "events/index.json",
      "persons/index.json",
    ],
