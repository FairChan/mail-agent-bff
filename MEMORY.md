...
- Codex global MCP config lives in `~/.codex/config.toml`; `magicui` and `reactbits` were added on 2026-04-18 via `npx` launch commands for UI-oriented component lookup.
